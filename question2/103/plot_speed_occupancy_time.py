...
# 视频的开始时间
start_time = datetime.strptime('12:56:47', '%H:%M:%S')  # 替换为您的视频开始时间
...
# 设置图例和标题
plt.title('Speed and Emergency Lane Occupancy Rate Over Time（点位4）', fontsize=18)
...
# 显示图表
plt.tight_layout()
plt.savefig('点位4时间、应急车道、速度关系图.png')
plt.show()
