...
output_path = 'E:/重邮/竞赛/研二/华为杯/赛题/E题/数据/11/draw1/108/归一化结果.xlsx'  # 保存路径
...
ax.set_title('3D Visualization of Speed, Density, and Time（点位3）', fontsize=15)
...
plt.savefig('点位3时间、速度、密度3D图_归一化.png')
plt.show()
