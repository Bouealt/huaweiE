...
# 读取多个Excel文件并合并
path = 'E:/重邮/竞赛/研二/华为杯/赛题/E题/数据/11/draw1/105/'  # 替换为您的文件路径
...
output_path = 'E:/重邮/竞赛/研二/华为杯/赛题/E题/数据/11/draw1/105/归一化结果.xlsx'  # 保存路径
...
# 视频开始时间
start_time = datetime.strptime('11:52:27', '%H:%M:%S')
...
ax.set_title('3D Visualization of Speed, Density, and Time（点位2）', fontsize=15)
...
plt.savefig('点位2时间、速度、密度3D图_归一化.png')
plt.show()
