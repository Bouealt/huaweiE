...
# 读取多个Excel文件并合并
path = 'E:/重邮/竞赛/研二/华为杯/赛题/E题/数据/11/draw1/103/'  # 替换为您的文件路径
...
output_path = 'E:/重邮/竞赛/研二/华为杯/赛题/E题/数据/11/draw1/103/归一化结果.xlsx'  # 保存路径
...
ax.set_title('3D Visualization of Speed, Density, and Time（点位4）', fontsize=15)
...
plt.savefig('点位4时间、速度、密度3D图_归一化.png')
plt.show()
